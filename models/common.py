...
def default_conv(in_channels, out_channels, kernel_size, bias=True, dilation=1):
    ...
    if(in_channels==2*out_channels):
        ...
        return SwinTransformerBlock(dim=in_channels,input_resolution=(16,16),num_heads=4,window_size=8,
        shift_size=2,mlp_ratio=2,down=True)
    if(out_channels==2*in_channels):

        return SwinTransformerBlock(dim=in_channels,input_resolution=(16,16),num_heads=4,window_size=8,
        shift_size=2,mlp_ratio=2,up=True)
    return SwinTransformerBlock(dim=in_channels,input_resolution=(16,16),num_heads=4,window_size=8,
